                    ...
                    <>
                      ...
                      >
                        <div className="w-full block relative border-b border-[#9198A4] group">
                          ...
                          <Field
                            type="text"
                            className="outline-none w-full text-white p-5 ps-12 text-sm lg:text-base bg-transparent"
                        ...
                        <div className="w-full block relative border-b border-[#9198A4] group">
                          ...
                          <Field
                            type="text"
                            name="subject"
                            className="outline-none  text-white w-full p-5 ps-12 text-sm lg:text-base bg-transparent"
                            placeholder="Subject"
                          />
                          <span className="uline absolute bottom-0 inset-x-0 w-0 bg-white h-[1px] group-focus:w-full anim"></span>
                        </div>
